...
export default function RegisterScreen() {
  ...
  return (
    <ScrollView
      ...
      className="px-6 pt-20 bg-background"
    >
      <Text className="text-4xl font-extrabold text-accent tracking-tight">
        Create Account
      </Text>
      <Text className="text-primary mt-2 mb-10">
        Your disciplined prep journey begins.
      </Text>
      <View className="space-y-5">
        ...
        <Text className="text-center text-success font-bold mt-6">
          ...
          <Link href="/auth/login" className="text-red-600  font-bold text-xl border border-accent-orange font-bold ">
            Login
          </Link>
        </Text>
      </View>
